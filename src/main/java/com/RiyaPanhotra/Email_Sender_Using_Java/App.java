package com.RiyaPanhotra.Email_Sender_Using_Java;
import java.io.File;
import java.util.*;
...
public class App 
{
	...
	public static void main( String[] args )
    {
		...
		String message = "I am Riya Panhotra Happy Coding  ";
		String subject = "Checking my Code";
		String to = "rs8657511@gmail.com";
		String from = "riyapanhotra17@gmail.com";
...
private static void sendAttachment(String message, String subject, String to, String from) {
	...
	Session session=Session.getInstance(properties, new Authenticator() {
		...
		protected PasswordAuthentication getPasswordAuthentication() {				
			return new PasswordAuthentication("riyapanhotra17@gmail.com","**********");
		}	
	});
	...
	//file path
	String path="C:\\Users\\Riya\\Desktop\\image\\hacker.jpg";
